...
// K has the comparable constraint
// meaning that we can compare value of this type with the == and !== operators
// this is required for map keys in Go
// V has the any constraint
// meaning that it's not restricted in any way (any is an alaias for interface{})
